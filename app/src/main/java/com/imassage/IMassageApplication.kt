...
import com.imassage.ui.dialog.account.birthday.EditAccountBirthdayDialogViewModelFactory
...
class IMassageApplication(
    ...
    override val kodein: Kodein = Kodein.lazy {
        ...
        bind() from provider { EditAccountBirthdayDialogViewModelFactory(instance()) }
